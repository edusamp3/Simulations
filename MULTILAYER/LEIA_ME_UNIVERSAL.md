...
É necessário Python 3.9 ou superior e conexão com a internet na primeira
...
O pacote inclui `.gitignore`. Ele impede o envio do ambiente `.venv`, vídeos,
caches e bibliotecas compiladas. O repositório deve conter apenas os fontes,
inicializadores, documentação e arquivos de configuração deste ZIP.
